			...
			if(typeof c !== "undefined"){
				...
				featureLayer.clearLayers(); 
					$.each(filteredData, function(index) {
						/* console.log(filteredData[index].fulcrum_id); */
						$.getJSON(config.geojson, function (data) {/* get filtered location */
							...
							alasql("SELECT * FROM ? WHERE properties->fulcrum_id =('"+filteredData[index].fulcrum_id+"')", [geojson.features], function(features){
